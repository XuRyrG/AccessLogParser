...
public class LogEntry {
    ...
    public LogEntry(String logString) {
        ...
        if (matcher.matches()) {
            ...
            this.dateTime = LocalDateTime.parse(matcher.group(2),
            ...
            throw new IllegalArgumentException("Не соответствует паттерну: " + logString);
        }
    }
    ...
    public HttpMethods getHttpMethod() { return httpMethod; }
